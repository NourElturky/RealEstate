  ...
  return (
    ...
    min-h-[800px] mb-14'>
        ...
        lg:items-center lg:justify-between'>
          ...
          <div className='txt-3xl font-semibold text-violet-600'>${house.price}</div>
        </div>
        ...
        gap-8 lg:flex-row'>
          ...
          px-6 py-8'>
            ...
            <form className='flex flex-col gap-y-4'>
              ...
              rounded w-full px-4 h-10 text-sm'
                type='text'
                placeholder='Name*' />
              <input className='border border-gray-300
              focus:border-violet-700 outline-none
              ...
              focus:border-violet-700 outline-none
              resize-none rounded w-full p-4 h-40
